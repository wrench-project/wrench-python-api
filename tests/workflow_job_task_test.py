...
if __name__ == "__main__":
    ...
    try:
        ...
        task1 = simulation.create_task("task1", 100.0, 1, 8, 1024)
        ...
        task2 = simulation.create_task("task2", 1000.0, 4, 4, 0)
        ...
        print(f"The tasks in the simulation are: {simulation.get_all_tasks()}")
